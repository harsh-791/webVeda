...
AI: Cursor (Grok). It drafted the first fetch/UI pass; I reworked error/currency handling, controls, and responsive layout. Chat link: [paste shared Cursor conversation URL here].
